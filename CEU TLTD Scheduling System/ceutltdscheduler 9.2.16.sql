...
CREATE TABLE `released_info` (
  `rel_reservation_no` int(100) DEFAULT NULL,
  ...
  UNIQUE KEY `rel_reservation_no_UNIQUE` (`rel_reservation_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reservation` (
  `reservationno` bigint(100) NOT NULL,
  `equipmentno` varchar(20) NOT NULL,
  `equipment` varchar(100) NOT NULL,
  `equipmentsn` varchar(50) NOT NULL,
  `id` varchar(20) NOT NULL,
...
INSERT INTO `reservation` VALUES (2402201684318118,'11','Mitsubishi XD420 ','1703085','13-02321','2016-09-02','03:00:00','04:00:00','admin','23','23','23'),(2402201684318118,'12','Mitsubishi EX100U','8715','13-02321','2016-09-02','03:00:00','04:00:00','admin','23','23','23'),(5002201614476196,'11','Mitsubishi XD420 ','1703085','13-02321','2016-07-25','01:00:00','02:00:00','admin','we','e','we'),(5002201614476196,'12','Mitsubishi EX100U','8715','13-02321','2016-07-25','01:00:00','02:00:00','admin','we','e','we');
...
CREATE TABLE `returned_info` (
  `ret_reservation_no` int(100) DEFAULT NULL,
  ...
  UNIQUE KEY `ret_reservation_no_UNIQUE` (`ret_reservation_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-09-02 11:52:13
