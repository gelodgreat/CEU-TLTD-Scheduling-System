...
CREATE TABLE `reservation` (
  ...
  UNIQUE KEY `reservationno` (`reservationno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reservation` VALUES (2147483647,'','2016-07-25','2016-07-25','01:00:00','02:00:00','Name ng Borrower','123','qewq','Released ');
...
CREATE TABLE `reservation_equipment` (
  ...
  `borrower` varchar(200) NOT NULL,
  KEY `reservationno` (`reservationno`),
  CONSTRAINT `reservation_equipment_ibfk_1` FOREIGN KEY (`reservationno`) REFERENCES `reservation` (`reservationno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reservation_equipment` VALUES (2147483647,'1703085','11','Mitsubishi XD420 ','Karaoke','Name ng Borrower'),(2147483647,'8715','12','Mitsubishi EX100U','Karaoke','Name ng Borrower'),(2147483647,'658705','KP #01','HR A290','Karaoke','Name ng Borrower');
...
-- Dump completed on 2016-08-26 11:43:37
