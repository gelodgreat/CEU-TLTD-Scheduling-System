...
INSERT INTO `accounts` VALUES ('13-02321','Angelo','Reyes','Umali','Scitech','Professor','admin','admin');
...
CREATE TABLE `released_info` (
  `rel_id_passnum` int(11) NOT NULL,
  `rel_reservation_no` bigint(100) NOT NULL,
...
INSERT INTO `released_info` VALUES (1,5002201614476196,'admin','5002201614476196','Mitsubishi XD420 ','2016-07-25','01:00:00','02:00:00','Released','Marco'),(2,2402201684318118,'admin','2402201684318118','Mitsubishi EX100U','2016-09-02','03:00:00','04:00:00','Released',''),(3,4705201642228501,'admin','4705201642228501','Lenovo','2016-09-05','01:00:00','02:00:00','Released','Wu');
...
CREATE TABLE `reservation` (
  ...
  PRIMARY KEY (`reservationno`,`equipmentno`,`equipment`,`equipmentsn`,`date`,`starttime`,`endtime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reservation` VALUES ('05072016-99975692','KP #01','HR A290','658705','13-02321','2016-09-07','01:00:00','02:00:00','Umali, Angelo','qawewq','qwae','qewq','Co-Curricular/Extra-Curricular'),('05072016-99975692','KP #01','HR A290','658705','13-02321','2016-09-07','03:00:00','04:00:00','Umali, Angelo','qawewq','qwae','qewq','Co-Curricular/Extra-Curricular'),('25072016-87829703','11','Mitsubishi XD420 ','1703085','13-02321','2016-09-07','01:00:00','02:00:00','Umali, Angelo','we','we','we','Academic'),('25072016-87829703','12','Mitsubishi EX100U','8715','13-02321','2016-09-07','01:00:00','02:00:00','Umali, Angelo','we','we','we','Academic'),('34072016-45976838','PCS-02','Altec Lansing 2420','xxx85','13-02321','2016-09-07','01:00:00','02:00:00','Umali, Angelo','we','e','e','Co-Curricular/Extra-Curricular');
...
INSERT INTO `reservation_equipments` VALUES ('05072016-99975692','KP #01','HR A290','658705'),('05072016-99975692','KP #01','HR A290','658705'),('25072016-87829703','11','Mitsubishi XD420 ','1703085'),('25072016-87829703','12','Mitsubishi EX100U','8715'),('34072016-45976838','PCS-02','Altec Lansing 2420','xxx85');
...
CREATE TABLE `returned_info` (
  ...
  `ret_id_passnum` int(11) NOT NULL,
  ...
  CONSTRAINT `rel_id_passnum` FOREIGN KEY (`ret_id_passnum`) REFERENCES `released_info` (`rel_id_passnum`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-09-07 16:44:29
